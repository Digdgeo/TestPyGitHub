...
class Map(ipyleaflet.Map):
    ...
    def __init__(self, **kwargs):
        ...
        tools = {
            "info": {"name": "inspector", "tooltip": "Inspector", "button_style":"primary"},
            "bar-chart": {"name": "plotting", "tooltip": "Plotting", "button_style":"primary"},
            "camera": {
                "name": "to_image",
            ...
            "thermometer-empty": {
                "name": "LST",
                "tooltip": "This will be the Land Surface Temperature Tool",
                "button_style":"warning",
            },
            "tint": {
                "name": "Flood",
                "tooltip": "Be water my friend",
                "button_style":"info",
            },
        }
        ...
        button_styles = [item["button_style"] for item in list(tools.values())]
        ...
        def tool_callback(change):
            ...
            if change["new"]:
                ...
                if tool_name == "to_image":
                    ...
                    print('Land Surface Temperature is coming!')

                elif tool_name == "Flood":
                    from .toolbar import WaterDetect
